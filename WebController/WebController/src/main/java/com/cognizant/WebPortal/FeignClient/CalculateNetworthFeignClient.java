package com.cognizant.WebPortal.FeignClient;
...
public interface CalculateNetworthFeignClient {
	...
	@PostMapping("/NetWorth/viewportfolio")
	public double viewPortfolio(@RequestHeader("Authorization") String token,@RequestBody SellObjectMap show);
}
